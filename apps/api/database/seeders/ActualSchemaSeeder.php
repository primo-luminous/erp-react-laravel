...
class ActualSchemaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        try {
            // Insert into existing companies table (actual schema)
            ...
            // Insert into existing departments table (actual schema)
            $departments = [
                [
                    'code' => 'IT001',
                    'name' => 'IT Department',
            ...
            // Insert into existing users table (actual schema)
            $users = [
                [
            ...
            // Insert into existing roles table (if exists)
            $roles = [
                [
                    'name' => 'super_admin',
            ...
            DB::commit();
            $this->command->info('Actual Schema Seeder completed successfully!');
            
        } catch (\Exception $e) {
            DB::rollBack();
            $this->command->error('Error in Actual Schema Seeder: ' . $e->getMessage());
            throw $e;
        }
    }
}
